...
<asp:Content ID="Content1" ContentPlaceHolderID="CustomerContent" runat="server">
    <div class="container">
        ...
        <asp:Label ID="GrandTotal" runat="server" Text="GrandTotal : " CssClass="offset-8 font-weight-bolder"></asp:Label>
        <asp:Label ID="GrandTotalValue" runat="server"></asp:Label>
        <asp:Button ID="PlaceOrder1" runat="server" OnClick="PlaceOrder1_Click" CssClass="text-center btn btn-success" style="margin-left:60px" Text="Place Order"></asp:Button>
    </div>
</asp:Content>
